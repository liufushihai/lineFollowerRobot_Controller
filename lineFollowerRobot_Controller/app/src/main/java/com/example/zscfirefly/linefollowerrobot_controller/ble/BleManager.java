package com.example.zscfirefly.linefollowerrobot_controller.ble;

import java.util.UUID;

import com.example.zscfirefly.linefollowerrobot_controller.R;
import com.example.zscfirefly.linefollowerrobot_controller.ble.BLEDevice.BLEDeviceCallback;
...
//				R.layout.device_list_item, R.id.device_name);
		mLeDeviceListAdapter =
				new ArrayAdapter<DeviceItem>(context,R.layout.devices_list_item,R.id.tv_dev_item);  //指定ArrayAdapter的上下文，子项会对应一个布局
		initBluetooth();
	}
